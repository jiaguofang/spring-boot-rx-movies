...
public final class MdcPropagatingAction implements Action0 {
    ...
    private static Logger logger = LoggerFactory.getLogger(MdcPropagatingAction.class);
    ...
    public MdcPropagatingAction(final Action0 action0) {
        logger.info("MdcPropagatingAction::MdcPropagatingAction " + action0);
    ...
    public void call() {
        ...
        logger.info("MdcPropagatingAction::call " + action0);
        if (context != null) {
